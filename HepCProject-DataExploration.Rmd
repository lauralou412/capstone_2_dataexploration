...
length(unique(hep_c_icd_dx$patient_id)) #3768 unique patient id's
...
nrow(subset(num_of_hep_c_codes_per_patient, total_num_of_hep_c_codes == 1)) #1295 unique patients with 1 hep c diagnosis code
nrow(subset(num_of_hep_c_codes_per_patient, total_num_of_hep_c_codes >= 5)) #1551 unique patients with 5 or greater hep c diagnosis code
```
